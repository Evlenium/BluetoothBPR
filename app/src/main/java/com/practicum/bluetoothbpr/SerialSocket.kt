...
//        }
        ...
        open fun connectCharacteristics(gattService: BluetoothGattService): Boolean {
    ...
    override fun onConnectionStateChange(gatt: BluetoothGatt, status: Int, newState: Int) {
        ...
        if (newState == BluetoothProfile.STATE_CONNECTED) {
            Log.d(
                TAG,
                "connect status $status, discoverServices"
            )
            ...
            Log.d(
                TAG,
                "unknown connect state $newState $status"
            )
        }
    ...
    private inner class NrfDelegate : DeviceDelegate() {
        override fun connectCharacteristics(gattService: BluetoothGattService): Boolean {
            ...
            if (rw2 != null && rw3 != null) {
                ...
                Log.d(
                    TAG,
                    "characteristic properties $rw2prop/$rw3prop"
                )
    ...
    private inner class TelitDelegate : DeviceDelegate() {
        ...
        override fun connectCharacteristics(gattService: BluetoothGattService): Boolean {
            ...
            val readCreditsDescriptor = readCreditsCharacteristic!!.getDescriptor(
                BLUETOOTH_LE_CCCD
            )
        ...
        override fun onCharacteristicChanged(
            ...
            if (characteristic === readCreditsCharacteristic) { // NOPMD - test object identity
                ...
                Log.d(
                    TAG,
                    "got write credits +$newCredits =$writeCredits"
                )
        ...
        override fun onCharacteristicWrite(
            ...
            if (characteristic === writeCharacteristic) { // NOPMD - test object identity
                ...
                Log.d(
                    TAG,
                    "write finished, credits=$writeCredits"
                )
            }
        ...
        private fun grantReadCredits() {
            ...
            if (readCredits <= minReadCredits) {
                ...
                Log.d(
                    TAG,
                    "grant read credits +$newCredits =$readCredits"
                )
    ...
    companion object {
        ...
        private val BLUETOOTH_LE_NRF_SERVICE =
        ...
        private val BLUETOOTH_LE_NRF_CHAR_RW3 =
        ...
        private val BLUETOOTH_LE_TIO_SERVICE =
